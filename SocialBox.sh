...
echo -e "	[+]              $red Coded By InYour./CYBER$nc         		   [+]"
echo -e "	[+] 		 $red www.instagram/mastah_illusion$nc 		   [+]"
echo -e "	[+] 		 $red Greetz To All Mister_XID || Fanx_ID || Patrick ||Mr.4NGGER$nc          		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {Jatim Blackhat , Bantumas Cyber Team, CodeXrush}$nc [+]"
echo ""
echo -e "$yellow Pilih MenuNya Cuk : $nc"
echo ""
